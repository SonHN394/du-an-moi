...
var options1, chart1, options, chart, areachartmini1Colors = getChartColorsArray("mini-chart-1"), areachartmini2Colors = (areachartmini1Colors && (options1 = {
    series: [{
...
getChartColorsArray("mini-chart-2")), areachartmini3Colors = (areachartmini2Colors && (options1 = {
    series: [{
...
getChartColorsArray("mini-chart-3")), areachartmini4Colors = (areachartmini3Colors && (options1 = {
    series: [{
...
getChartColorsArray("mini-chart-4")), areachartmini5Colors = (areachartmini4Colors && (options1 = {
    series: [{
...
getChartColorsArray("mini-chart-5")), areachartmini6Colors = (areachartmini5Colors && (options1 = {
    series: [{
...
getChartColorsArray("mini-chart-6")), areachartmini7Colors = (areachartmini6Colors && (options1 = {
    series: [{
        data: [50, 15, 35, 62, 23, 56, 44, 12]
    }],
    chart: {
...
getChartColorsArray("mini-chart-7")), areachartmini8Colors = (areachartmini7Colors && (options1 = {
    series: [{
        data: [50, 15, 20, 34, 23, 56, 65, 41]
    }],
    chart: {
...
getChartColorsArray("mini-chart-8")), dealTypeChartsColors = (areachartmini8Colors && (options1 = {
    series: [{
        data: [45, 53, 24, 89, 63, 60, 36, 50]
    }],
    chart: {
...
getChartColorsArray("deal-type-charts")), swiper = (dealTypeChartsColors && (options = {
    series: [{
        name: "Ethereum",
...
}), barchartColors = getChartColorsArray("market-overview"), linechartBasicColors = (barchartColors && (options = {
    series: [{
        name: "Like",
...
getChartColorsArray("line_chart_basic")), worldemapmarkers = (linechartBasicColors && (options = {
    series: [{
        name: "Artwork",
...
function loadCharts() {
    ...
    e && (document.getElementById("creators-by-locations").innerHTML = "",
    worldemapmarkers = "",
